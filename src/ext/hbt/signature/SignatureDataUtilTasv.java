...
public class SignatureDataUtilTasv {
	...
	public static ApplicationData getgetPDFInContent(ContentHolder cholder) throws WTException
	{
		...
		while (contents.hasMoreElements())
		{
			...
			/*	if (fileName.startsWith(SignatureConstant.PRINT_FILE_PRF) && fileName.toLowerCase().endsWith(".pdf"))
				{
					app = tempapp;
					break;
				}*/
				if (fileName.toLowerCase().endsWith(".pdf")&& !fileName.startsWith("Print"))
				{
					app = tempapp;
					break;
				}
	...
	public static String getSigneObjectType(WTObject obj) throws WTException
	{
		...
		try
		{
			if (obj instanceof EPMDocument)
			{
				...
				System.out.println("CAD文档的类型为"+objtype);
			}
	...
	{
		ApplicationData app = SignatureDataUtilTasv.getPDFInRep((Representable) obj);
		return app;
	}
